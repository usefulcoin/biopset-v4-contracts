...
const ITCO = artifacts.require("ITCO");
                                ...
                                return deployer
                                  ...
                                  .then(async (tiersInstance) => {
                                    return deployer
                                      .deploy(
                                        FakeERC20,
                                        FakeERC20Settings.toMint
                                      )
                                      .then(async (fakeERC20) => {
                                        return deployer
                                          .deploy(ITCO, fakeERC20.address)
                                          .then(async (ibcoInstance) => {
                                            return deployer
                                              .deploy(GovProxy)
                                              .then(async (proxyInstance) => {
                                                return deployer
                                                  ...
                                                  .then(async (govInstance) => {
                                                    ...
                                                    return await biopInstance.disableWhitelist(
                                                    );
